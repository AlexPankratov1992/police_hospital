...
class Patient_doctor_history extends MY_Model
{

  const DB_TABLE = 'patient_doctor_history';
  const DB_TABLE_PK = 'patient_doctor_history_id';

  /**
   * Table unique identifier.
   * @var int
   */
  public $patient_doctor_history_id;
