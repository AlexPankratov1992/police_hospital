    ...
    <?php echo form_open('account/signup',array("id"=>"signupForm", "role"=>"form",)); ?>
      <fieldset>
        ...
        <div>
          ...
          <div class="form-group">
            <div class="col-md-6">
              <?php echo form_dropdown('position',$roles_option,$this->input->post('position'),"class='form-control' title='Position' id='user_role'");?>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="form-group" style="display: none;" id="fee_tab">
                <div class="col-md-12">
                    <input min="0" type="number" name='fees' id='fees' value="" class='form-control' placeholder='Doctor Fees' title='Doctor Fees' required />
                </div>
            </div>
          <div class="clearfix"></div>
        </div>
