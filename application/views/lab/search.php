<div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          echo form_button('quickAddLab', '+ Quick Add Test', ' id="quickAddLab" style="margin-top: 10px; border: 0px solid; display:none"'); // 
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#quickAddLab').click(function() {
        // Step 1: add Lab
        // let drugName = $('#drugQ').val();
        $.post("<?php echo site_url('test/quickAddLab'); ?>", $('#formTestQ').serialize(),
          function(data) {
            console.log(data);
            // Step 2: Search same lab and show
            $.post("<?php echo site_url('test/search'); ?>", $('#formTestQ').serialize(),
              function(data) {
                $('#testResult').html(data);
              });
