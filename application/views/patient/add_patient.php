    ...
    <fieldset>
      ...
      <div>
        ...
        <div class="form-group">
          <div class="col-md-6"><input type="text" name='card_no' maxlength="13" id="card_no" value="<?php echo $this->input->post('card_no'); ?>" class='form-control' placeholder='Card No' title='Card No' required autofocus /></div>
          <div class="col-md-6"><input type="text" name='fee' maxlength="13" id="fee" value="<?php echo $this->input->post('fee'); ?>" class='form-control' placeholder='Fee' title='Card No' required autofocus /></div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-md-6"><input type='phone' maxlength='11' name='phone' id='phone' value="<?php echo $this->input->post('phone'); ?>" class='form-control' placeholder='Phone' title='Phone' required /></div>
        </div>
        <div class="form-group">
          <div class="col-md-6">
            <input type="date" name='age' id='age' value="<?php echo $this->input->post('age'); ?>" class='form-control' placeholder='Age' title='Date of Birth' required />
