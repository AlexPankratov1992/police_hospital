  ...
  <div class="col col-md-8 well well-md">
    ...
    <fieldset>
      ...
      <div>
        <div class="form-group">
          <div class="col-md-6">
            <div><input type="text" name='card_no' id="card_no" value="<?php echo set_value('card_no', $patient->card_no); ?>" class='form-control' placeholder='Card No' title='Card No' required autofocus /></div>
          </div>
    ...
    <fieldset>
      ...
      <div>
        ...
        <div class="form-group">
          <div class="col-md-6"><input type="date" name='birth_date' id='birth_date' value="<?php echo set_value('birth_date', $patient->birth_date); ?>" class='form-control' placeholder='Birth Date' title='Birth Date' /></div>
        </div>
        <div class="clearfix"></div>
      </div>
    </fieldset>
