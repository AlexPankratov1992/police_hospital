          ...
          <td colspan="2">
            <div class="header">
              ...
              <div class="credentials">
                <h4>Dr. Mushtaq Ahmed Memon</h4>
                <p>M.B.B.S., D.C.H.</p>
                <small>Fatima Jinnah Colony, Jamshed Road # 3, Karachi.</small>
                <br />
                <small>Mb. 03422817157</small> <br />
                <small>Timing : 11:00 AM to 02:00 PM</small> <br />
                <small> 05:00 PM to 08:00 PM</small> <br />
                <small> (Except Sunday)</small> <br />
              </div>
            </div>
          </td>
        </tr>
            ...
            <div class="desease_details">
              ...
              <div class="tests">
                ...
                <div class="test_action">
                  <button id="test_save" data-prescription_id="<?php //echo $presc->prescription_id; 
                                                                ?>" class="btn btn-sm btn-success save">Save</button>
                  <button class="btn btn-sm btn-danger cancel-btn">Cancel</button>
                </div>
              </div>
              <div class="advice">
                <h4 class="d-header">Comments</h4>
                ...
                <div class="adv_action">
                  <button id="adv_save" data-prescription_id="<?php //echo $presc->prescription_id; 
                                                              ?>" class="btn btn-sm btn-success save">Save</button>
                  <button class="btn btn-sm btn-danger cancel-btn">Cancel</button>
                </div>
              </div>
          ...
          <td width="60%" valign="top">
            ...
            <div class="medicine">
              <section class="med_list">
                <div class="med">
                  ⚫ <input class="med_name" data-med_id="2" data-toggle="tooltip" title="Click to edit..." placeholder="Enter medicine name" value="panadol">
                  ...
                  <div class="med_footer">
                    <div class="period">
                      Take for <input class="med_period" type="text" data-med_id="2" placeholder="? days/weeks...">
                      <div class="med_period_action" style="display: none;">
                        <button data-med_id="2" class="btn btn-sm btn-success save">✓</button>
                      </div>
                      <span class="date">(Untill 11-2-2022)</span>
                    </div>
                ...
                <div class="med">
                  ⚫ <input class="med_name" data-med_id="4" data-toggle="tooltip" title="Click to edit..." placeholder="Enter medicine name" value="Nuberol forte">
                  <div class="med_name_action" style="display: none;">
                    <button data-med_id="4" class="btn btn-sm btn-success save">Save</button>
                    <button class="btn btn-sm btn-danger cancel-btn">Cancel</button>
                  </div>
                  <div class="schedual">
                    <div class="sc_time">
                      <select class="sc" data-med_id="4">
                        <option value="1+1+1" selected="">1+1+1</option>
                        <option value="1+0+1">1+0+1</option>
                        <option value="0+1+1">1+1+1</option>
                        <option value="1+0+0">1+1+1</option>
                      ...
                      <div class="med_when_action" style="display: none;">
                        <button data-med_id="4" class="btn btn-sm btn-success save">✓</button>
                      </div>
                    </div>
                    <div class="taking_time select">
                      <select class="meal" data-med_id="4">
                        <option value="1" selected="">After Meal</option>
                        <option value="2">Before Meal</option>
                        <option value="3">Take any time</option>
                      </select>
                  ...
                  <div class="med_footer">
                    <div class="period">
                      Take for <input class="med_period" type="text" data-med_id="4" placeholder="? days/weeks...">
                      <div class="med_period_action" style="display: none;">
                        <button data-med_id="4" class="btn btn-sm btn-success save">✓</button>
                      </div>
                      <span class="date">(Untill 11-2-2022)</span>
                    ...
                    <div class="del_action">
                      <button data-med_id="4" class="btn btn-sm btn-danger delete"><i class="fa fa-trash" aria-hidden="true"></i></button>
                    </div>
                  </div>
                  <hr>
                </div>
