    ...
    <fieldset>
      ...
      <div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6"><input type="hidden" name='xray_name_fa' id='xray_name_fa' value="dummmy" class='form-control' placeholder='نام اکسری' title='نام اکسری' required /></div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-6"><input type="hidden" name='price' id='price' value="1" class='form-control' placeholder='Price(AF)' title='Price (AF)' required /></div>
        </div>
